BEGIN TRY
    ...
    (8, N'Clean Sweep', N'This badge is for completing a drive to all clinics.', N'You’ve completed drives to all of our clinics. Thanks so much!', N'assets/badges/14.png', 2, N'uspCheckBadgeAllClinics', NULL, NULL, 0, NULL, 1, 0, @utcNow, NULL, 13),
    ...
    (14, N'HWRS', N'This badge is for completing a drive to Houston Women''s Reproductive Services.', N'Thanks for completing a drive to Houston Women''s Reproductive Services. :)', N'assets/badges/25.png', 2, N'uspCheckBadgeSingleClinic', 10, 1, 0, NULL, 1, 0, @utcNow, NULL, 12),
    (15, N'Quick Draw', N'This badge is for applying for a drive within 30 minutes of it being posted.', N'Way to go, Speedy! You applied quickly after the drive was posted.', N'assets/badges/2.png', 1, N'uspCheckBadgeQuickDraw', NULL, NULL, 1, NULL, 1, 0, @utcNow, NULL, 14),
    (16, N'Early Bird', N'This badge is for applying a drive at least one week in advance.', N'Thanks for applying a week in advance! Way to support abortion access.', N'assets/badges/4.png', 1, N'uspCheckBadgeEarlyBird', NULL, NULL, 1, NULL, 1, 0, @utcNow, NULL, 15),
    (17, N'LTC', N'This badge is for completing a drive to a Lam to Complete appointment.', N'Lam to Complete appointments are so important to staff. Thank you for your help!', N'assets/badges/5.png', 2, N'uspCheckBadge', NULL, 1, 0, 6, 1, 0, @utcNow, NULL, 16)
    COMMIT TRANSACTION
END TRY
BEGIN CATCH
