...
CREATE TABLE IF NOT EXISTS `casn-app`.`volunteer` (
  ...
  `hasTextConsent` BIT(1) NOT NULL DEFAULT b'1',
...
CREATE TABLE IF NOT EXISTS `casn-app`.`drive` (
  ...
  `statusId` INT UNSIGNED NOT NULL DEFAULT 0,
  ...
  `cancelReasonId` INT UNSIGNED NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_drive_DriverId`
    ...
    REFERENCES `casn-app`.`volunteer` (`id`)
    ON DELETE RESTRICT,
  CONSTRAINT `fk_drive_ApprovedById`
    FOREIGN KEY (`approvedById`)
    REFERENCES `casn-app`.`volunteer` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_drive_cancelReasonId`
    FOREIGN KEY (`cancelReasonId`)
    REFERENCES `casn-app`.`drivecancelreason` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_drive_statusId`
...
SHOW WARNINGS;
CREATE INDEX `fk_drive_ApprovedById_idx` ON `casn-app`.`drive` (`approvedById` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_drive_cancelReasonId_idx` ON `casn-app`.`drive` (`cancelReasonId` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_drive_statusId_idx` ON `casn-app`.`drive` (`statusId` ASC);
...
-- -----------------------------------------------------
-- Table `casn-app`.`message`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `casn-app`.`message` (
...
-- -----------------------------------------------------
-- Table `casn-app`.`badge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `casn-app`.`badge` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `casn-app`.`volunteer_badge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `casn-app`.`volunteer_badge` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `volunteerId` INT UNSIGNED NOT NULL,
  ...
  `updated` DATETIME NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_volunteer_badge_volunteerId`
    FOREIGN KEY (`volunteerId`)
    REFERENCES `casn-app`.`volunteer` (`id`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_volunteer_badge_badgeId`
    FOREIGN KEY (`badgeId`)
    REFERENCES `casn-app`.`badge` (`id`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT)
ENGINE = InnoDB;

SHOW WARNINGS;
CREATE INDEX `fk_volunteer_badge_volunteerId_idx` ON `casn-app`.`volunteer_badge` (`volunteerId` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_volunteer_badge_badgeId_idx` ON `casn-app`.`volunteer_badge` (`badgeId` ASC);
