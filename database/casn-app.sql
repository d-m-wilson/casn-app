...
-- Wed Jun 20 22:14:13 2018
-- Model: casn-app data model    Version: 0.01
...
CREATE TABLE IF NOT EXISTS `casn-app`.`patient` (
  `Id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `CiviContactId` INT(10) UNSIGNED NOT NULL,
  `PatientIdentifier` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL,
  `FirstName` VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `LastName` VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
