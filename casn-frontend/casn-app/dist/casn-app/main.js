...
var DefaultService = /** @class */ (function () {
    function DefaultService(httpClient, basePath, configuration) {
        ...
        this.basePath = 'https://virtserver.swaggerhub.com/d-m-wilson/CASN_App_OAS3/1.0.0';
...
var routes = [
    ...
    { path: 'patient', component: _patients_patients_component__WEBPACK_IMPORTED_MODULE_4__["PatientsComponent"], canActivate: [_auth_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
];
...
/* harmony import */ var _auth_services_auth_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./auth-services/auth.service */ "./src/app/auth-services/auth.service.ts");
/* harmony import */ var _auth_services_fake_backend__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./auth-services/fake-backend */ "./src/app/auth-services/fake-backend.ts");
/* harmony import */ var _auth_services_jwt_interceptor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./auth-services/jwt.interceptor */ "./src/app/auth-services/jwt.interceptor.ts");
/* harmony import */ var _auth_services_error_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./auth-services/error.interceptor */ "./src/app/auth-services/error.interceptor.ts");
/* harmony import */ var _auth_services_user_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./auth-services/user.service */ "./src/app/auth-services/user.service.ts");
/* harmony import */ var _api_api_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./api/api.module */ "./src/app/api/api.module.ts");
...
/* harmony import */ var _patients_patients_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./patients/patients.component */ "./src/app/patients/patients.component.ts");
/* harmony import */ var _rides_rides_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./rides/rides.component */ "./src/app/rides/rides.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _patients_patients_component__WEBPACK_IMPORTED_MODULE_17__["PatientsComponent"],
                _rides_rides_component__WEBPACK_IMPORTED_MODULE_18__["RidesComponent"],
            ...
            providers: [
                _api_api_module__WEBPACK_IMPORTED_MODULE_14__["ApiModule"],
                _auth_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"],
                _auth_services_auth_service__WEBPACK_IMPORTED_MODULE_9__["AuthenticationService"],
                _auth_services_user_service__WEBPACK_IMPORTED_MODULE_13__["UserService"],
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: _auth_services_jwt_interceptor__WEBPACK_IMPORTED_MODULE_11__["JwtInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: _auth_services_error_interceptor__WEBPACK_IMPORTED_MODULE_12__["ErrorInterceptor"], multi: true },
                // provider used to create fake backend for dev
                _auth_services_fake_backend__WEBPACK_IMPORTED_MODULE_10__["fakeBackendProvider"]
            ],
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _api_api_dispatcher_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../api/api/dispatcher.service */ "./src/app/api/api/dispatcher.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PatientsComponent = /** @class */ (function () {
    ...
    **********************************************************************/
    function PatientsComponent(dispatcherService) {
        ...
        **********************************************************************/
        ...
        this.patientForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            ...
            preferredLanguage: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            preferredContactMethod: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
        });
        this.patientSearchControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]();
    }
    ...
    PatientsComponent.prototype._filter = function (value) {
        var filterValue = value.toLowerCase();
        return this.patientOptions.filter(function (option) { return option.toLowerCase().includes(filterValue); });
    };
    /*********************************************************************
                        Service Calls
    **********************************************************************/
    PatientsComponent.prototype.getAppts = function () {
        this.dispatcherService.getAllAppointmentsForDispatcher().subscribe(function (a) {
    ...
    PatientsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_api_api_dispatcher_service__WEBPACK_IMPORTED_MODULE_3__["DispatcherService"]])
    ], PatientsComponent);
